...
km_countdata <- 
posdata$rank <- rowMedians(countdata)
...
volcanoplot(res_TUCR,genes=c("uc.62","uc.110","uc.193","uc.210","uc.427"),title = "TUCR deregulation in GBM", output = paste(outputdir,"/tucr_results_volcanoplot.png",sep=""))
...
heatmap.TUCRs2 <- heatmap.TUCRs2 %>% 
  gather(key = "Sample", value = "RPKM",-TUCRids,-means) %>% 
  filter(TUCRids == "uc.62"|TUCRids == "uc.110"|TUCRids == "uc.193"|TUCRids == "uc.210"|TUCRids == "uc.427")
