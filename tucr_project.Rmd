...
mergedcounts <- "lgg_mergedcounts.txt"
...
save(tucr.cor.matrix3,geneindex,TUCRids,file="lgg_matrixintermediate.RData")
rm(list=ls())
load(file="lgg_matrixintermediate.RData")}else{
  load(file=intermediatefile)
}
...
```{r DESeq2plots_intergenicTUCRs, message = FALSE, eval=FALSE}
