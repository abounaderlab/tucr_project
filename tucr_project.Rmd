...
write.csv(res_exonic, file = paste(outputdir,"/results_exonicOnly.csv",sep=""))

volcanoplot(res_exonic,genes=c("uc.90","uc.213"), 
            title = paste("exonic TUCR deregulation in ",disease,sep=""),
            output = paste(outputdir,"/exonic_tucr_results_volcanoplot.png",sep=""))

res_intronic <- inner_join(res_TUCR,tucr_annot,by = "row") %>%
  filter(annot == "intronic")

write.csv(res_intronic, file = paste(outputdir,"/results_intronicOnly.csv",sep=""))

volcanoplot(res_intronic,genes=c("uc.430","uc.275"), 
            title = paste("intronic TUCR deregulation in ",disease,sep=""),
            output = paste(outputdir,"/intronic_tucr_results_volcanoplot.png",sep=""))

res_exonic_intronic <- inner_join(res_TUCR,tucr_annot,by = "row") %>%
  filter(annot == "exonic/intronic")

write.csv(res_exonic_intronic, file = paste(outputdir,"/results_exonic_intronicOnly.csv",sep=""))

volcanoplot(res_exonic_intronic,genes=c("uc.282","uc.341"), 
            title = paste("exonic/intronic TUCR deregulation in ",disease,sep=""),
            output = paste(outputdir,"/exonic_intronic_tucr_results_volcanoplot.png",sep=""))
...
if(annotation == "TUCR"){
  ...
  write.csv(rpkm.TUCRs2,paste(outputdir,"/",disease,"_rpkm_TUCRs2.csv",sep=""))
}
...
if(!dir.exists(paste(outputdir,"/RPKM","/FCplots",sep=""))){
  dir.create(paste(outputdir,"/RPKM","/FCplots",sep=""))
}
  
rpkm.TUCRs2 <- read.csv(paste(outputdir,"/",disease,"_rpkm_TUCRs2.csv",sep=""),header=TRUE)
...
res_TUCR <- read_csv(paste(outputdir,"/results_TUCR.csv",sep="")) %>%
...
ggsave(p2,file=paste(outputdir,"/RPKM","/FCplots/",TUCR,"_FC_plot.png",sep = ""))
}
...
write_csv(surv_TUCR,paste(outputdir,"/SurvivalAnalysis/survival_TUCRs.csv",sep=""))
...
for(i in 1:length(TUCRids)){
  ...
  if(skip_to_next) { 
    ...
    ptable[i,] <- rbinder
    next } 
  ggsave(file=paste(outputdir,"/SurvivalAnalysis/tucrKPMplots/",TUCR,"_kpmplot.png",sep = ""),
         plot = print(p))
...
write_csv(ptable,paste(outputdir,"/SurvivalAnalysis/kpm_summary_TUCRs.csv",sep=""))
...
surv_TUCR <- read.csv(paste(outputdir,"/SurvivalAnalysis/survival_TUCRs.csv",sep=""),header=TRUE)

ptable <- read.csv(paste(outputdir,"/SurvivalAnalysis/kpm_summary_TUCRs.csv",sep=""),header=TRUE)
...
write.csv(res_surv_sum2,file=paste(outputdir,"/SurvivalAnalysis/tucr_surv_table_",annotation,".csv",sep=""))
...
ggsave(file=paste(outputdir,"/SurvivalAnalysis/tucr_surv_bar_",annotation,".png",sep=""),plot = print(p), width = 5, height = 5, dpi = 300)

volcanosurv(res_surv_sum3, genes = "", title = paste(annotation," TUCR correlation with patient survival in ",disease,sep=""),output = paste(outputdir,"/SurvivalAnalysis/",annotation,"_tucr_results_volcanosurv.png",sep=""))
}
