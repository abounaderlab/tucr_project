...
TUCRids <- read.csv("tucr_annot.csv",header=TRUE) %>%
...
if(annotation == "TUCR"){rpkm.TUCRs2 <- rpkm.df2}
...
rpkm.dotplot <- rpkm.dotplot %>% 
  ...
  dplyr::select(-Sample,-Key,-id,-string)
...
ggsave(p,file=paste(outputdir,"/cellcountingdata/",experimentlabel,".png",sep = ""),width=15,height=7,dpi=300)}
