...
stringtiecounts2 <- stringtiecounts[,6:ncol(stringtiecounts)]
rownames(stringtiecounts2) <- stringtiecounts[,5]
...
CHESScounts2 <- CHESScounts[,6:ncol(CHESScounts)]
rownames(CHESScounts2) <- CHESScounts[,5]
