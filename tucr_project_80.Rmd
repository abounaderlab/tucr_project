...
tucrcounts <- read.table("tucr_counts_80.txt",header = TRUE)
...
countdata <- read.table("tucr_counts_80.txt",header = TRUE)
metadata <- read_csv(file = "tcga_metadata.csv")
...
volcanoplot(res_TUCR,genes=c("uc.62","uc.110","uc.193","uc.210","uc.427","uc.212","uc.341"),title = "TUCR deregulation in GBM", output = paste(outputdir,"/myron_results_volcanoplot.png",sep=""))
