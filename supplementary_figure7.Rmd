...
```{r supplementary_Figure7_dircreate}
...
```{r Supplementary_Figure7ab_relatingmodules_1,eval=FALSE}
...
```{r Supplementary_Figure7a_relatingmodules_2,fig.width = 3, fig.height = 7,eval=FALSE}
...
```{r Supplementary_Figure7ab_relatingmodules_3,eval=FALSE}
...
```{r Supplementary_Figure7abFigure1h_mainheatmap,eval=FALSE}
...
## Supplementary_Figure7A
```{r Supplementary_Figure7a_allgoterms,eval=FALSE}
...
ggsave(plot = print(p),paste(outputdir,"/Figure7_Supplementary/supplementary_Figure7a.png",sep=""),height=8,width=16)

```

## supplimentary Figure 7B 

```{r Supplementary_Figure7b_allgoterms,eval=FALSE}
...
ggsave(plot = print(p),paste(outputdir,"/Figure7_Supplementary/supplementary_Figure7b.png",sep=""),height=8,width=16)
